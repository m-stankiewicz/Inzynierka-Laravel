...
class FillPermissionsForVatRate extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForVatRate constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.vat-rate',
            'admin.vat-rate.index',
            'admin.vat-rate.create',
            'admin.vat-rate.show',
            'admin.vat-rate.edit',
            'admin.vat-rate.delete',
            'admin.vat-rate.bulk-delete',
        ]);
