...
class FillPermissionsForInvoiceSeries extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForInvoiceSeries constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.invoice-series',
            'admin.invoice-series.index',
            'admin.invoice-series.create',
            'admin.invoice-series.show',
            'admin.invoice-series.edit',
            'admin.invoice-series.delete',
            'admin.invoice-series.bulk-delete',
        ]);
