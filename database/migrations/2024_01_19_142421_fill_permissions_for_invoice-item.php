...
class FillPermissionsForInvoiceItem extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForInvoiceItem constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.invoice-item',
            'admin.invoice-item.index',
            'admin.invoice-item.create',
            'admin.invoice-item.show',
            'admin.invoice-item.edit',
            'admin.invoice-item.delete',
            'admin.invoice-item.bulk-delete',
        ]);
